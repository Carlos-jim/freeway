...
export const registerFlight = async (flight) => {
    const { airline_id, flight_number, departure_airport, arrival_airport, departure_time, arrival_time } = flight;
    const [insert_database] = await pool.query(
        ...
        [airline_id, flight_number, departure_airport, arrival_airport, departure_time, arrival_time]
    );
